...
export class NewModalService {
  ...
  private componentFactory: ComponentFactory<NewModalComponent>;
  ...
  public create(templateModalComponent, data) {
    if (!this.componentFactory) {
      this.componentFactory = this.componentFactoryResolver.resolveComponentFactory(NewModalComponent);
